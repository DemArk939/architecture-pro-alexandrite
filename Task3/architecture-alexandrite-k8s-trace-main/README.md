...
kubectl delete validatingwebhookconfiguration jaeger-operator-validating-webhook-configuration
...
Ждем, пока не стартует jaeger-operato, и не появится simplest:
```bash
